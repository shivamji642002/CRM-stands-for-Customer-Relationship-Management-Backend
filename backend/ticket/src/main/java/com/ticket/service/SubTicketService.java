...
public class SubTicketService {
    ...
    public List<SubTicket> getSubTasksByParentSubTask(SubTicket parentSubTicket) {
        return subTicketRepository.findByParentSubTicket(parentSubTicket);
    }
    
    public SubTicket loadSubTicketHierarchy(Long id) {
        // TODO: Implement the logic to load the full sub-ticket hierarchy
